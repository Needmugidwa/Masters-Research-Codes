...
def main():
    ...
    train_dataset_full = datasets.ImageFolder(
        r"C:\Users\Gaming PC\Documents\2 Datasets _Aptos_Idrid_imbalanced\Client2_Train_Set",
        transform=transform_train)
    val_dataset_full = datasets.ImageFolder(
        r"C:\Users\Gaming PC\Documents\2 Datasets _Aptos_Idrid_imbalanced\Client_2_val",
        transform=transform_val)
    # Client configuration (run with different client_id for each client)
    client_id = 1  # Change this (0-3) for each of your 4 clients
    num_clients = 2
